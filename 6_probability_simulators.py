        ...
        def get_results(numbers):
            ...
            for num in numbers:
                if num.get_value() > 0.1:
                    result = (
                        SVGMobject(f"{HOME}\\green_tick.svg")
                        .set_color(GREEN_C)
                        .set(width=0.3)
                    )
                else:
                    result = (
                        SVGMobject(f"{HOME}\\cross.svg")
                        .set_color(RED_C)
                        .set(width=0.3)
                    )
...
def get_data_1(self):
            ...
            t_row1 = (
                VGroup(
                    *[
                        SVGMobject(f"{HOME}\\green_tick.svg").set(width=w).set_color(GREEN)
                        for i in range(10)
                    ]
                )
            ...
            t_row2 = (
                VGroup(
                    *[
                        SVGMobject(f"{HOME}\\cross.svg").set(width=w).set_color(RED)
                        for i in range(10)
                    ]
                )
                .arrange(RIGHT, buff=0.2)
